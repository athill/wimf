...
import ValidatedInput, { InputLabel } from '../../../components/common/ValidatedInput';
...
describe('InputLabel', () => {
	...
	it('works', () => {
		...
		expect(output.props().children).toBe(title);
	});
...
describe('ValidatedInput', () => {
	...
	it('renders read-only', () => {
		...
		expect(formControl.length).toBe(1);
		expect(formControl.props().children).toBe(input.value);
	});
