...
import Container from '../../../../components/pages/items/Container';
  ...
  it('hides empty categories', () => {
    ...
    allCategoryNames.forEach((categoryName, index) => {
      if (index === noItemsIndex) {
        expect(displayedCategoryNames).not.toContain(categoryName);
      } else {
        expect(displayedCategoryNames).toContain(categoryName);  
      }
